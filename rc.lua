...
beautiful.init(gears.filesystem.get_dir("config") .. "themes/zenburn/theme.lua")
...
run_once.run_once("xrandr --output eDP-1 --brightness 0.8")
run_once.run_once("fcitx5")
--run_once.run_once("dropbox")
run_once.run_once("nutstore")
--run_once.run_once("compton -b")
